...
function fnPropertyChanged() {
	if (window.event.propertyName == "src") {
		...
		if (!el.src.match(/x\.gif$/i)) {
			...
			el.src = "/ucomm/templatedependents/templatesharedcode/scripts/x.gif";
		}
	}
}
...
function fnPropertyChanged_back() {
	if (window.event.propertyName == "style.backgroundImage") {
		...
		if (!el.currentStyle.backgroundImage.match(/x\.gif/i)) {
			...
			el.style.backgroundImage = "url(/ucomm/templatedependents/templatesharedcode/scripts/x.gif)";
		}
	}
}
...
function fnFixPng_back(obj) {
	...
	obj.style.backgroundImage = "url(/ucomm/templatedependents/templatesharedcode/scripts/x.gif)";
}